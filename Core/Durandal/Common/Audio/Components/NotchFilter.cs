...
{
    public sealed class NotchFilter : BiquadFilter
    {
        private float _q;
        private float _frequency;

        /// <summary>
        /// Constructs a new notch filter.
        /// </summary>
        ...
        public NotchFilter(WeakPointer<IAudioGraph> graph, AudioSampleFormat format, string nodeCustomName, float frequencyHz, float q = 0.70721f)
            : base(graph, format, nameof(NotchFilter), nodeCustomName)
        {
            if (frequencyHz < 0)
            {
