...
namespace Durandal.Common.Compression.BZip2
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="Durandal.Common.Compression.BZip2.BZip2OutputStream"/>,
    ...
    /// </para>
    ///
    /// <seealso cref="Durandal.Common.Compression.BZip2.BZip2OutputStream" />
    public class ParallelBZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new Durandal.Common.Compression.BZip2.ParallelBZip2OutputStream(output))
        ///           {
        ...
        ///   </code>
        /// </example>
        public ParallelBZip2OutputStream(IThreadPool threadPool, Stream output, ILogger logger)
            : this(threadPool, output, BZip2.MaxBlockSize, false, logger)
        {
        }
        ...
        public ParallelBZip2OutputStream(IThreadPool threadPool, Stream output, int blockSize, ILogger logger)
            : this(threadPool, output, blockSize, false, logger)
        {
        }
        ...
        /// </param>
        /// <param name="logger">A logger</param>
        public ParallelBZip2OutputStream(IThreadPool threadPool, Stream output, bool leaveOpen, ILogger logger)
            : this(threadPool, output, BZip2.MaxBlockSize, leaveOpen, logger)
        {
        }
        ...
        /// </param>
        /// <param name="logger">A logger</param>
        public ParallelBZip2OutputStream(IThreadPool threadPool, Stream output, int blockSize, bool leaveOpen, ILogger logger)
        {
        ...
        public new void Dispose()
        {
            if (this.pendingException != null)
            {
                ...
                var pe = ExceptionDispatchInfo.Capture(this.pendingException);
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            do
            {
                ...
                if (n != bytesRemaining)
                {
                    _threadPool.Value.EnqueueUserWorkItem(() => CompressOne(workitem));
        ...
        public override bool CanWrite
        {
            get
            {
                if (this.output == null) throw new ObjectDisposedException(nameof(ParallelBZip2OutputStream));
        ...
        private void TraceOutput(TraceBits bits, string format, params object[] varParams)
        {
            ...
            {
                _logger.Log(string.Format("PBOS " + format, varParams), LogLevel.Vrb);
            }
        }
