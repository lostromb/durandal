...
{
    /// <summary>
    /// Managed version of CRC32C which takes advantage of 32-bit SSE4.2 CRC32 intrinsics.
    /// </summary>
    public class ManagedCRC32C_SSE_X86 : ICRC32C
    {
        ...
        public void Slurp(ref CRC32CState state, ReadOnlySpan<byte> input_8)
        {
            ...
            {
                throw new PlatformNotSupportedException("Platform architecture does not support CRC32 extension");
            }
#endif
            int end_idx_8;
            //buffer end;
            ...
            while (length >= 3 * LONG_SHIFT_8)
            {
                ...
                do
                {
                    crc0 = Sse42.Crc32(crc0, input_32[input_idx_32]);
                    crc1 = Sse42.Crc32(crc1, input_32[input_idx_32 + LONG_SHIFT_32]);
                    crc2 = Sse42.Crc32(crc2, input_32[input_idx_32 + (2 * LONG_SHIFT_32)]);
            ...
            while (length >= 3 * SHORT_SHIFT_8)
            {
                ...
                {
                    crc0 = Sse42.Crc32(crc0, input_32[input_idx_32]);
                    crc1 = Sse42.Crc32(crc1, input_32[input_idx_32 + SHORT_SHIFT_32]);
                    crc2 = Sse42.Crc32(crc2, input_32[input_idx_32 + (2 * SHORT_SHIFT_32)]);
                    input_idx_8 += sizeof(uint);
                    input_idx_32 += 1;
                } while (input_idx_8 < end_idx_8);
            ...
            while (length != 0)
            {
                crc0 = Sse42.Crc32(crc0, input_8[input_idx_8++]);
                --length;
            }
