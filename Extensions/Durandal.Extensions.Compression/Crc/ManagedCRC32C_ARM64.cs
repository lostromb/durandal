...
namespace Durandal.Extensions.Compression.Crc
{
    ...
    /// </summary>
    public class ManagedCRC32C_ARM64 : ICRC32C
    {
        ...
        public void Slurp(ref CRC32CState state, ReadOnlySpan<byte> input_8)
        {
            ...
            {
                throw new PlatformNotSupportedException("Platform architecture does not support CRC32.ARM64 extension");
            }
#endif
            int end_idx_8;
            uint crc0, crc1, crc2;
            ...
            {
                crc0 = Crc32.ComputeCrc32C(crc0, input_8[misalignedByte]);
            }
            ...
            while (length >= 3 * LONG_SHIFT_8)
            {
                ...
                do
                {
                    crc0 = Crc32.Arm64.ComputeCrc32C(crc0, input_64[input_idx_64]);
                    crc1 = Crc32.Arm64.ComputeCrc32C(crc1, input_64[input_idx_64 + LONG_SHIFT_64]);
                    crc2 = Crc32.Arm64.ComputeCrc32C(crc2, input_64[input_idx_64 + (2 * LONG_SHIFT_64)]);
            ...
            while (length >= 3 * SHORT_SHIFT_8)
            {
                ...
                {
                    crc0 = Crc32.Arm64.ComputeCrc32C(crc0, input_64[input_idx_64]);
                    crc1 = Crc32.Arm64.ComputeCrc32C(crc1, input_64[input_idx_64 + SHORT_SHIFT_64]);
                    crc2 = Crc32.Arm64.ComputeCrc32C(crc2, input_64[input_idx_64 + (2 * SHORT_SHIFT_64)]);
                    input_idx_8 += sizeof(ulong);
                    input_idx_64 += 1;
                } while (input_idx_8 < end_idx_8);
            ...
            while (length != 0)
            {
                crc0 = Crc32.ComputeCrc32C((uint)crc0, input_8[input_idx_8++]);
                --length;
            }
