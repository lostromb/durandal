...
{
    public class ALawCodecFactory : IAudioCodecFactory
    {
        /// <summary>
        /// The codec code for 8-bit alaw codec
        /// </summary>
        public static readonly string CODEC_NAME = "alaw";
            ...
            string nodeCustomName)
        {
            ...
            return new ALawDecoder(graph, codecParams, nodeCustomName);
        }
            ...
            string nodeCustomName)
        {
            ...
            return new ALawEncoder(graph, desiredInputFormat, nodeCustomName);
        }
    }
}
