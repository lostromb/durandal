...
namespace Durandal.Common.Collections.Interning.Impl
{
    ...
    /// </summary>
    internal class SealedInternalizer_Char_PerfectHash : ISealedPrimitiveInternalizer<char>
    {
        ...
        public SealedInternalizer_Char_PerfectHash(IEnumerable<KeyValuePair<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>> entries)
        {
            if (entries == null)
            {
