...
{
    [TestClass]
    public class TestCacheOptimizedInternalizer
    {
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_Basic()
        {
            ...
            SealedInternalizer_CharIgnoreCase_CacheOptimized internalizer = new SealedInternalizer_CharIgnoreCase_CacheOptimized(dict);
            Assert.AreEqual(InternalizerFeature.CaseInsensitive, internalizer.Features);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_Random()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_NullInput()
        {
            try
            {
                SealedInternalizer_CharIgnoreCase_CacheOptimized internalizer = new SealedInternalizer_CharIgnoreCase_CacheOptimized(null);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_ContainsEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_ZeroZeroIsAllowed()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_ContainsMultipleEmptyValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            dict[new InternedKey<ReadOnlyMemory<char>>(1)] = new char[0];
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_DoesntContainEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_DoesntContainEmpty2()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_NoInputs()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            SealedInternalizer_CharIgnoreCase_CacheOptimized internalizer = new SealedInternalizer_CharIgnoreCase_CacheOptimized(dict);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_ThrowsExceptionOnDuplicateValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            dict[new InternedKey<ReadOnlyMemory<char>>(1)] = "One".AsMemory();
            dict[new InternedKey<ReadOnlyMemory<char>>(2)] = "One".AsMemory();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_ReliablyConstructsTree()
        {
            IRandom random = new FastRandom(112);
            StringBuilder builder = new StringBuilder();
            HashSet<string> existingStrings = new HashSet<string>();
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_RedundantOrdinals()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_CacheOptimized_CaseSensitivity()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
