...
namespace Durandal.Common.Compression.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        /// </remarks>
        protected ZipEntry(ILogger logger, IFileSystem fileSystem)
        {
            _CompressionMethod = (Int16)CompressionMethod.Deflate;
            _CompressionLevel = Durandal.Common.Compression.ZLib.CompressionLevel.Default;
            _Encryption = EncryptionAlgorithm.None;
            _Source = ZipEntrySource.None;
            _logger = logger;
            _fileSystem = fileSystem;
            AlternateEncoding = SharedUtilities.GetIBM437Encoding();
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = Durandal.Common.Compression.Zip.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipEntry.LastModified"/>
        ...
        internal VirtualPath LocalFileName
        {
        ...
        ///   file, via a call to ZipFile.AddFile() or
        ///   ZipFile.AddItem(), or a related overload, the value
        ...
        ///
        /// <para>
        ///   If an application reads a <c>ZipFile</c> via  ZipFile.Read() or a related overload, and then explicitly
        ...
        ///   stream (for example, when the <c>ZipEntry</c> was added with ZipFile.AddFile() or ZipFile.AddDirectory(), or when the entry was added by
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)Durandal.Common.Compression.Zip.CompressionMethod.None)
                    _CompressionLevel = Durandal.Common.Compression.ZLib.CompressionLevel.None;
                else if (CompressionLevel == Durandal.Common.Compression.ZLib.CompressionLevel.None)
                    _CompressionLevel = Durandal.Common.Compression.ZLib.CompressionLevel.Default;
        ...
        ///
        /// <seealso cref="CompressionMethod"/>
        public Durandal.Common.Compression.ZLib.CompressionLevel CompressionLevel
        {
            get
            {
            ...
            set
            {
                ...
                if (value == Durandal.Common.Compression.ZLib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == Durandal.Common.Compression.ZLib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == Durandal.Common.Compression.ZLib.CompressionLevel.None)
                    _CompressionMethod = (short)Durandal.Common.Compression.Zip.CompressionMethod.None;
                else
                    _CompressionMethod = (short)Durandal.Common.Compression.Zip.CompressionMethod.Deflate;
        ...
        /// </remarks>
        ///
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        ///
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipEntry.CompressedSize"/>
        ...
        /// </exception>
        ///
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipEntry.Password">ZipEntry.Password</seealso>
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.Encryption">ZipFile.Encryption</seealso>
        ...
        /// </example>
        ///
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipEntry.Encryption"/>
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.Password">ZipFile.Password</seealso>
        ...
        ///
        /// </remarks>
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.ExtractExistingFile"/>
        ///
        /// <example>
        ...
        ///
        /// </remarks>
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.ZipErrorAction"/>
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.ZipError"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            get
            {
                return (AlternateEncoding == System.Text.Encoding.UTF8) &&
            ...
            set
            {
                ...
                {
                    AlternateEncoding = Durandal.Common.Compression.Zip.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        internal static string NameInArchive(VirtualPath filename, string directoryPathInArchive)
        {
            string result = null;
            if (directoryPathInArchive == null)
            ...
            else
            {
                ...
                {
                    // explicitly specify a pathname for this file
                    result = Path.Combine(directoryPathInArchive, filename.Name);
                }
            }
        ...
        // workitem 9073
        internal static ZipEntry CreateFromNothing(ILogger logger, IFileSystem fileSystem, String nameInArchive)
        {
            return Create(nameInArchive, ZipEntrySource.None, logger, fileSystem, null, null);
        }

        internal static ZipEntry CreateFromFile(ILogger logger, IFileSystem fileSystem, VirtualPath filename, string nameInArchive)
        {
            return Create(nameInArchive, ZipEntrySource.FileSystem, logger, fileSystem, filename, null);
        }

        internal static ZipEntry CreateForStream(ILogger logger, IFileSystem fileSystem, String entryName, Stream s)
        {
            return Create(entryName, ZipEntrySource.Stream, logger, fileSystem, s, null);
        }

        internal static ZipEntry CreateForWriter(ILogger logger, IFileSystem fileSystem, String entryName, WriteDelegate d)
        {
            return Create(entryName, ZipEntrySource.WriteDelegate, logger, fileSystem, d, null);
        }

        internal static ZipEntry CreateForJitStreamProvider(ILogger logger, IFileSystem fileSystem, string nameInArchive, OpenDelegate opener, CloseDelegate closer)
        {
            return Create(nameInArchive, ZipEntrySource.JitStream, logger, fileSystem, opener, closer);
        }

        internal static ZipEntry CreateForZipOutputStream(ILogger logger, IFileSystem fileSystem, string nameInArchive)
        {
            return Create(nameInArchive, ZipEntrySource.ZipOutputStream, logger, fileSystem, null, null);
        }


        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, ILogger logger, IFileSystem fileSystem, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new Durandal.Common.Compression.Zip.ZipException("The entry name must be non-null and non-empty.");

            ZipEntry entry = new ZipEntry(logger, fileSystem);
            ...
            {
                VirtualPath filename = (arg1 as VirtualPath);   // must not be null

                if (filename == null)
                    throw new Durandal.Common.Compression.Zip.ZipException("The filename must be non-null and non-empty.");
        ...
        internal VirtualPath _LocalFileName;
        ...
        private Durandal.Common.Compression.ZLib.CompressionLevel _CompressionLevel;
        ...
        private static System.Text.Encoding ibm437 = SharedUtilities.GetIBM437Encoding();
