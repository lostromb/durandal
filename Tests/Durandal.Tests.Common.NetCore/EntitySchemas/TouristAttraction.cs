...
namespace Durandal.Tests.EntitySchemas
{
    ...
    /// </summary>
    internal class TouristAttraction : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/Place", "http://schema.org/Thing" };

        public TouristAttraction(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/TouristAttraction", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public TouristAttraction(Entity castFrom) : base(castFrom, "http://schema.org/TouristAttraction") { Initialize(); }
        ...
        {
            TouristType_as_string = new TextValue(_context, EntityId, "touristType");
            TouristType_as_Audience = new IdentifierValue<Entity>(_context, EntityId, "touristType");
        ...
        /// <summary>
        /// <para>(From http://schema.org/TouristAttraction)</para>
        /// <para>Attraction suitable for type(s) of tourist. eg. Children, visitors from a particular country, etc.</para>
        /// </summary>
        public TextValue TouristType_as_string { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/TouristAttraction)</para>
        /// <para>Attraction suitable for type(s) of tourist. eg. Children, visitors from a particular country, etc.</para>
        /// </summary>
        public IdentifierValue<Entity> TouristType_as_Audience { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/TouristAttraction)</para>
