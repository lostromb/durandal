...
{
    /// <summary>
    /// Rough implementation of MD5 hash algorithm.
    /// </summary>
    public static class MD5
    {
        private static readonly int[] shifts = new int[] { 7, 12, 17, 22, 5, 9, 14, 20, 4, 11, 16, 23, 6, 10, 15, 21 };

        private static readonly uint[] sines = new uint[] {
        ...
        /// <summary>
        /// quick and dirty implementation of MD5 hash algorithm
        /// </summary>
        /// <param name="input"></param>
        /// <returns>A 16-element byte array containing the hash</returns>
