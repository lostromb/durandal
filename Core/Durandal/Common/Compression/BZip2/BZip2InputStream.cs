...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:Durandal.Common.Compression.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace Durandal.Common.Compression.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly Durandal.Common.Compression.PkZipCRC32 crc = new Durandal.Common.Compression.PkZipCRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new Durandal.Common.Compression.BZip2.BZip2InputStream(fs))
        ///       {
        ...
        public override bool CanRead
        {
            get
            {
                if (_disposed) throw new ObjectDisposedException(nameof(BZip2InputStream));
        ...
        private void getAndMoveToFrontDecode()
        {
            ...
            while (nextSym != eob)
            {
                ...
                else
                {
                    ...
                    {
                        ArrayExtensions.MemCopy(yy, 0, yy, 1, nextSym - 1);
                    }
