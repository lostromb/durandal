...
namespace Durandal.Common.Time.TimeZone
{
    ...
    public static class TimeZoneHelpers
    {
        ...
        /// <returns></returns>
        public static TimeZoneQueryResult CalculateMarinersTime(GeoCoordinate coordinate, DateTimeOffset utcTime)
        {
        ...
        /// <returns></returns>
        public static int ParseMonthName(string name)
        {
        ...
        /// <summary>
        /// Parses a day of week name string in the form "Mon" into a 0-based integer (C# numbering, not ISO, so day 0 == Sunday)
        /// </summary>
        /// <param name="name"></param>
        /// <returns></returns>
        public static int ParseDayOfWeekName(string name)
        {
        ...
        /// <returns></returns>
        public static TimeSpan RoundOffsetToNearestMinute(TimeSpan input)
        {
