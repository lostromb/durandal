...
namespace ManagedBass
{
    ...
    public struct BassInfo
    {
        ...
        /// </summary>
        public int TotalHardwareMemory
        {
            get
            {
                return hwsize;
        ...
        public bool IsCertified
        {
            get
            {
                return flags.HasFlag(BASSInfoFlags.Certified);
            }
        }
        ...
        public bool Supports16BitSamples
        {
            get
            {
                return flags.HasFlag(BASSInfoFlags.Secondary16Bit);
            }
        }
        ...
        public bool Supports8BitSamples
        {
            get
            {
                return flags.HasFlag(BASSInfoFlags.Secondary8Bit);
            }
        }
        ...
        public bool SupportsContinuousRate
        {
            get
            {
                return flags.HasFlag(BASSInfoFlags.ContinuousRate);
            }
        }
        ...
        public bool SupportsDirectSound
        {
            get
            {
                return !flags.HasFlag(BASSInfoFlags.EmulatedDrivers);
            }
        }
        ...
        public bool SupportsMonoSamples
        {
            get
            {
                return flags.HasFlag(BASSInfoFlags.Mono);
            }
        }
        ...
        public bool SupportsStereoSamples
        {
            get
            {
                return flags.HasFlag(BASSInfoFlags.Stereo);
            }
        }
    }
}
