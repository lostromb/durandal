...
namespace Durandal.Common.Speech.Triggers.Sphinx.Internal.Structs
{
    internal class mdef_t
    {
        ...
        public hash_table_t ciphone_ht;   /*< Hash table for mapping ciphone strings to ids */
        ...
        public Pointer<Pointer<ph_lc_t>> wpos_ci_lclist;    /*< wpos_ci_lclist[wpos][ci] = list of lc for <wpos,ci>.
