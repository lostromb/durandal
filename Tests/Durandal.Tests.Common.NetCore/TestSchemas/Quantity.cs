...
namespace Durandal.Tests.TestSchemas
{
    ...
    public class Quantity : Entity
    {
        ...
        public Quantity(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/Quantity", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public Quantity(Entity castFrom) : base(castFrom, "http://schema.org/Quantity") { Initialize(); }
