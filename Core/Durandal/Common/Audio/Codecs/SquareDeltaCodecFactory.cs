...
{
    public class SquareDeltaCodecFactory : IAudioCodecFactory
    {
        /// <summary>
        /// The codec code for 8-bit square-root delta codec
        /// </summary>
        public static readonly string CODEC_NAME = "sqrt";
            ...
            string nodeCustomName)
        {
            ...
            return new SquareDeltaDecoder(graph, codecParams, nodeCustomName);
        }
            ...
            string nodeCustomName)
        {
            ...
            return new SquareDeltaEncoder(graph, desiredInputFormat, nodeCustomName);
        }
    }
}
