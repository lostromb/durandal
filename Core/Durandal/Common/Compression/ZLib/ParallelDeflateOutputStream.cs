...
namespace Durandal.Common.Compression.ZLib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        Durandal.Common.Compression.ZLib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="Durandal.Common.Compression.ZLib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="Durandal.Common.Compression.ZLib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private Durandal.Common.Compression.PkZipCRC32             _runningCrc;
        ...
        private Durandal.Common.Compression.ZLib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="Durandal.Common.Compression.ZLib.DeflateStream"/>,
        ...
        /// </code>
        /// </example>
        /// <param name="threadPool">A thread pool for queueing work items.</param>
        /// <param name="logger">A logger</param>
        /// <param name="stream">The stream to which compressed data will be written.</param>
        public ParallelDeflateOutputStream(IThreadPool threadPool, ILogger logger, System.IO.Stream stream)
            : this(threadPool, logger, stream, CompressionLevel.Default, CompressionStrategy.Default, false)
        {
        }
        ...
        public ParallelDeflateOutputStream(IThreadPool threadPool, ILogger logger, System.IO.Stream stream, CompressionLevel level)
            : this(threadPool, logger, stream, level, CompressionStrategy.Default, false)
        {
        }
        ...
        /// </param>
        public ParallelDeflateOutputStream(IThreadPool threadPool, ILogger logger, System.IO.Stream stream, bool leaveOpen)
            : this(threadPool, logger, stream, CompressionLevel.Default, CompressionStrategy.Default, leaveOpen)
        {
        }
        ...
        ///    true if the application would like the stream to remain open after inflation/deflation.
        /// </param>
        public ParallelDeflateOutputStream(IThreadPool threadPool, ILogger logger, System.IO.Stream stream, CompressionLevel level, bool leaveOpen)
            : this(threadPool, logger, stream, CompressionLevel.Default, CompressionStrategy.Default, leaveOpen)
        {
        }
        ...
        ///   cref="Durandal.Common.Compression.ZLib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new Durandal.Common.Compression.PkZipCRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="Durandal.Common.Compression.ZLib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            if (_pendingException != null)
            {
                ...
                var pe = ExceptionDispatchInfo.Capture(_pendingException);
            ...
            do
            {
                ...
                if (workitem.inputBytesAvailable == workitem.buffer.Length)
                {
                    ...
                    _threadPool.Value.EnqueueUserWorkItem(() => _DeflateOne(workitem));
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    Durandal.Common.Compression.ZLib.CRC32 c= new Durandal.Common.Compression.ZLib.CRC32();
                    do
                    {
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                Durandal.Common.Compression.PkZipCRC32 crc = new Durandal.Common.Compression.PkZipCRC32();
        ...
        private void TraceOutput(TraceBits bits, string format, params object[] varParams)
        {
            ...
            {
                _logger.Log(string.Format("PDOS " + format, varParams), LogLevel.Vrb);
            }
        }
