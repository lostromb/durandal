...
{
    /// <summary>
    /// <para>SportsActivityLocation</para>
    /// <para>A sports location, such as a playing field.</para>
    /// </summary>
    public class SportsActivityLocation : Entity
    {
        ...
        public SportsActivityLocation(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/SportsActivityLocation", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public SportsActivityLocation(Entity castFrom) : base(castFrom, "http://schema.org/SportsActivityLocation") { Initialize(); }
