...
namespace Durandal.Internal.CoreOntology.SchemaDotOrg
{
    ...
    /// </summary>
    internal class Restaurant : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/FoodEstablishment", "http://schema.org/LocalBusiness", "http://schema.org/Place", "http://schema.org/Organization", "http://schema.org/Thing" };

        public Restaurant(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/Restaurant", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public Restaurant(Entity castFrom) : base(castFrom, "http://schema.org/Restaurant") { Initialize(); }
