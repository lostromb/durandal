...
namespace Durandal.Tests.EntitySchemas
{
    ...
    internal class Book : Entity
    {
        ...
        public Book(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/Book", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public Book(Entity castFrom) : base(castFrom, "http://schema.org/Book") { Initialize(); }
        ...
        {
            Isbn = new TextValue(_context, EntityId, "isbn");
            BookEdition = new TextValue(_context, EntityId, "bookEdition");
            BookFormat = new IdentifierValue<Entity>(_context, EntityId, "bookFormat");
            NumberOfPages = new IdentifierValue<Entity>(_context, EntityId, "numberOfPages");
            Illustrator = new IdentifierValue<Person>(_context, EntityId, "illustrator");
        ...
        /// <summary>
        /// <para>(From http://schema.org/Book)</para>
        /// <para>The ISBN of the book.</para>
        /// </summary>
        public TextValue Isbn { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Book)</para>
        /// <para>The edition of the book.</para>
        /// </summary>
        public TextValue BookEdition { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Book)</para>
        /// <para>The format of the book.</para>
        /// </summary>
        public IdentifierValue<Entity> BookFormat { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Book)</para>
        /// <para>The number of pages in the book.</para>
        /// </summary>
        public IdentifierValue<Entity> NumberOfPages { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Book)</para>
        /// <para>The illustrator of the book.</para>
        /// </summary>
        public IdentifierValue<Person> Illustrator { get; private set; }
        /// <summary>
