...
namespace ManagedBass
{
    public static partial class Bass
    {
        ...
        {      
            return (PluginInfo)Marshal.PtrToStructure(BASS_PluginGetInfo(Handle), typeof(PluginInfo));
        }
        ...
        public static int PluginLoad(string FilePath)
        {
            ...
            return new[] { 
                    string.Format("{0}{1}.dll", dir, fileName),
                    string.Format("{0}lib{1}.so", dir, fileName),
                    string.Format("{0}lib{1}.dylib", dir, fileName) }
                           .Select(PluginLoad)
        ...
        public static Dictionary<string, int> PluginLoadDirectory(string Folder)
        {
            ...
            var wildcards = new[] { "bass*.dll", "libbass*.so", "libbass*.dylib" };
