...
namespace Durandal.Common.MathExt.FFT
{
    ...
    {
        internal int fct;
        internal int tw; // originally these were ComplexF* pointers, but they just indexed into plan.mem
    ...
    internal class PlanComplexPackedFloat32 : IComplex1DFFTPlanFloat32
    {
...
#else
        internal cfftp_fctdata[] fct; // [FFTConstants.NFCT]
#endif
        ...
        public PlanComplexPackedFloat32(int length)
        {
            ...
            {
                this.fct = new cfftp_fctdata[FFTConstants.NFCT];
            }
#endif
            ...
            this.mem = BufferPool<ComplexF>.Rent(tws);
        ...
        private void cfftp_comp_twiddle()
        {
            ...
            for (int k = 0; k < this.nfct; ++k)
            {
                ...
                Span<ComplexF> tw = this.mem.Buffer.AsSpan(memofs);
                memofs += (ip - 1) * (ido - 1);
                for (int j = 1; j < ip; ++j)
                {
                    for (int i = 1; i < ido; ++i)
                ...
                if (ip > 11)
                {
                    ...
                    Span<ComplexF> tws = this.mem.Buffer.AsSpan(memofs);
                    memofs += ip;
                    for (int j = 0; j < ip; ++j)
                    {
        ...
        private void pass_all(Span<ComplexF> c, float fct, int sign)
        {
            if (this.length == 1)
            {
                return;
            ...
            int len = this.length;
            int l1 = 1, nf = nfct;
            using (PooledBuffer<ComplexF> pooledScratch = BufferPool<ComplexF>.Rent(len))
            {
                ComplexF[] scratchArray = pooledScratch.Buffer;
                Span<ComplexF> ch = scratchArray;
                Span<ComplexF> p1 = c;
                Span<ComplexF> p2 = ch;
        ...
        private static void pass2b(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa)
        {
            const int cdim = 2;
        ...
        private static void pass2f(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa)
        {
            const int cdim = 2;
        ...
        private static void pass3b(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa)
        {
            const int cdim = 3;
        ...
        private static void pass3f(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa)
        {
            const int cdim = 3;
            const float tw1r = -0.5f, tw1i = -0.86602540378443864676f;
        ...
        private static void pass4b(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa)
        {
            const int cdim = 4;
            ...
            if (ido == 1)
            {
                for (int k = 0; k < l1; ++k)
                {
                    ComplexF t1 = default, t2 = default, t3 = default, t4 = default;
                    FFTIntrinsics.PMC(
                        ref t2,
                        ref t1,
                        ref cc[(0) + ido * ((0) + cdim * (k))],
            ...
            else
            {
                for (int k = 0; k < l1; ++k)
                {
                    ...
                    for (int i = 1; i < ido; ++i)
                    {
                        ComplexF c2 = default, c3 = default, c4 = default;
                        ComplexF cc0 = cc[(i) + ido * ((0) + cdim * (k))],
        ...
        private static void pass4f(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa)
        {
            const int cdim = 4;
        ...
        private static void pass5b(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa)
        {
            const int cdim = 5;
            ...
            if (ido == 1)
            {
                for (int k = 0; k < l1; ++k)
                {
                    ComplexF t0 = cc[(0) + ido * ((0) + cdim * (k))], t1 = default, t2 = default, t3 = default, t4 = default;
                    ComplexF ca = default, cb = default;
                    FFTIntrinsics.PMC(
                        ref t1,
                        ref t4,
                        ref cc[(0) + ido * ((1) + cdim * (k))],
                    ...
                    FFTIntrinsics.PMC(
                        ...
                        ref cc[(0) + ido * ((2) + cdim * (k))],
                        ref cc[(0) + ido * ((3) + cdim * (k))]);
                    ref ComplexF z = ref ch[(0) + ido * ((k) + l1 * (0))];
            ...
            else
            {
                for (int k = 0; k < l1; ++k)
                {
                    ...
                    for (int i = 1; i < ido; ++i)
                    {
                        ComplexF da = default, db = default;
                        t0 = cc[(i) + ido * ((0) + cdim * (k))];
                        FFTIntrinsics.PMC(
                            ref t1,
                            ref t4,
        ...
        static void pass5f(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa)
        {
            const int cdim = 5;
            const float tw1r = 0.3090169943749474241f,
                tw1i = -0.95105651629515357212f,
        ...
        private static void pass7(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa, int sign)
        {
            const int cdim = 7;
            ...
            ComplexF t1 = default, t2 = default, t3 = default, t4 = default, t5 = default, t6 = default, t7 = default;
            ComplexF ca = default, cb = default, da = default, db = default;
        ...
        private static void pass11(int ido, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa, int sign)
        {
            const int cdim = 11;
            ...
            ComplexF t1 = default, t2 = default, t3 = default, t4 = default, t5 = default, t6 = default, t7 = default, t8 = default, t9 = default, t10 = default, t11 = default;
            ComplexF ca = default, cb = default, da = default, db = default;
            if (ido == 1)
            {
                for (int k = 0; k < l1; ++k)
        ...
        private static void passg(int ido, int ip, int l1, Span<ComplexF> cc, Span<ComplexF> ch, Span<ComplexF> wa, Span<ComplexF> csarr, int sign)
        {
            int cdim = ip;
            int ipph = (ip + 1) / 2;
            int idl1 = ido * l1;
            using (PooledBuffer<ComplexF> pooledWal = BufferPool<ComplexF>.Rent(ip))
            {
                ComplexF[] wal = pooledWal.Buffer;
                wal[0] = new ComplexF(1.0f, 0.0f);

                for (int i = 1; i < ip; ++i)
                {
                    wal[i] = new ComplexF(csarr[i].Re, sign * csarr[i].Im);
                }
                ...
                for (int k = 0; k < l1; ++k)
                {
                    for (int i = 0; i < ido; ++i)
                    {
                        ComplexF tmp = ch[(i) + ido * ((k) + l1 * (0))];
                        for (int j = 1; j < ipph; ++j)
                        {
                            ref ComplexF z = ref ch[(i) + ido * ((k) + l1 * (j))];
                            tmp.Re += z.Re;
                            tmp.Im += z.Im;
                        }
