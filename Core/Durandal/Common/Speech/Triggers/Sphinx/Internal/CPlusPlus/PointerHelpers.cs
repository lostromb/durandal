...
namespace Durandal.Common.Speech.Triggers.Sphinx.Internal.CPlusPlus
{
    ...
    internal static class PointerHelpers
    {
        ...
        /// <param name="capacity"></param>
        /// <returns></returns>
        internal static Pointer<E> Malloc<E>(uint capacity)
        {
        ...
        internal static void ZeroOutStruct<T>(this Pointer<T> ptr, int length) where T : class, new()
        {
        ...
        internal static Pointer<E> NULL<E>()
        {
            return default(Pointer<E>);
        }

        internal static bool IsPrimitiveIntegerType(Type type)
        {
