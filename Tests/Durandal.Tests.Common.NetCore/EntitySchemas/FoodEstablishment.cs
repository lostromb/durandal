...
{
    /// <summary>
    /// <para>FoodEstablishment</para>
    /// <para>A food-related business.</para>
    /// </summary>
    internal class FoodEstablishment : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/LocalBusiness", "http://schema.org/Place", "http://schema.org/Organization", "http://schema.org/Thing" };

        public FoodEstablishment(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/FoodEstablishment", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public FoodEstablishment(Entity castFrom) : base(castFrom, "http://schema.org/FoodEstablishment") { Initialize(); }
        ...
        {
            ServesCuisine = new TextValue(_context, EntityId, "servesCuisine");
            HasMenu_as_string = new TextValue(_context, EntityId, "hasMenu");
            HasMenu_as_URL = new TextValue(_context, EntityId, "hasMenu");
            HasMenu_as_Menu = new IdentifierValue<Entity>(_context, EntityId, "hasMenu");
            Menu_as_string = new TextValue(_context, EntityId, "menu");
            Menu_as_URL = new TextValue(_context, EntityId, "menu");
            Menu_as_Menu = new IdentifierValue<Entity>(_context, EntityId, "menu");
            StarRating = new IdentifierValue<Entity>(_context, EntityId, "starRating");
            AcceptsReservations_as_URL = new TextValue(_context, EntityId, "acceptsReservations");
            AcceptsReservations_as_bool = new BooleanValue(_context, EntityId, "acceptsReservations");
            AcceptsReservations_as_string = new TextValue(_context, EntityId, "acceptsReservations");
            ...
            Map = new TextValue(_context, EntityId, "map");
            BranchCode = new TextValue(_context, EntityId, "branchCode");
            HasMap_as_URL = new TextValue(_context, EntityId, "hasMap");
            ...
            Logo_as_URL = new TextValue(_context, EntityId, "logo");
            ...
            Maps = new TextValue(_context, EntityId, "maps");
            ...
            NumberOfEmployees = new IdentifierValue<Entity>(_context, EntityId, "numberOfEmployees");
        ...
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        /// <para>The cuisine of the restaurant.</para>
        /// </summary>
        public TextValue ServesCuisine { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        /// <para>Either the actual menu as a structured representation, as text, or a URL of the menu.</para>
        /// </summary>
        public TextValue HasMenu_as_string { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        /// <para>Either the actual menu as a structured representation, as text, or a URL of the menu.</para>
        /// </summary>
        public TextValue HasMenu_as_URL { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        /// <para>Either the actual menu as a structured representation, as text, or a URL of the menu.</para>
        /// </summary>
        public IdentifierValue<Entity> HasMenu_as_Menu { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        /// <para>Either the actual menu as a structured representation, as text, or a URL of the menu.</para>
        /// </summary>
        public TextValue Menu_as_string { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        /// <para>Either the actual menu as a structured representation, as text, or a URL of the menu.</para>
        /// </summary>
        public TextValue Menu_as_URL { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        /// <para>Either the actual menu as a structured representation, as text, or a URL of the menu.</para>
        /// </summary>
        public IdentifierValue<Entity> Menu_as_Menu { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        ...
        /// </summary>
        public IdentifierValue<Entity> StarRating { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        ...
        /// </summary>
        public TextValue AcceptsReservations_as_URL { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        /// <para>Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings <code>Yes</code> or <code>No</code>.</para>
        /// </summary>
        public BooleanValue AcceptsReservations_as_bool { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/FoodEstablishment)</para>
        /// <para>Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings <code>Yes</code> or <code>No</code>.</para>
        /// </summary>
        public TextValue AcceptsReservations_as_string { get; private set; }
        /// <summary>
        ...
        /// </summary>
        public TextValue Map { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Place)</para>
        ...
        /// <para>A URL to a map of the place.</para>
        /// </summary>
        public TextValue HasMap_as_URL { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Place)</para>
        /// <para>A URL to a map of the place.</para>
        /// </summary>
        ...
        /// </summary>
        public TextValue Logo_as_URL { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Place)</para>
        /// <para>An associated logo.</para>
        /// </summary>
        ...
        /// <para>A URL to a map of the place.</para>
        /// </summary>
        public TextValue Maps { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Place)</para>
        ...
        /// </summary>
        public IdentifierValue<Entity> NumberOfEmployees { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Organization)</para>
