...
{
    [TestClass]
    public class Test_SealedInternalizer_Byte_Linear
    {
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_Basic()
        {
            ...
            SealedInternalizer_Byte_Linear internalizer = new SealedInternalizer_Byte_Linear(dict);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_Random()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_NullInput()
        {
            try
            {
                SealedInternalizer_Byte_Linear internalizer = new SealedInternalizer_Byte_Linear(null);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_ContainsEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>> dict = new Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_ZeroZeroIsAllowed()
        {
            Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>> dict = new Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_ContainsMultipleEmptyValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>> dict = new Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>>();
            dict[new InternedKey<ReadOnlyMemory<byte>>(1)] = new byte[0];
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_DoesntContainEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>> dict = new Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_DoesntContainEmpty2()
        {
            Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>> dict = new Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_NoInputs()
        {
            Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>> dict = new Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>>();
            SealedInternalizer_Byte_Linear internalizer = new SealedInternalizer_Byte_Linear(dict);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_ThrowsExceptionOnDuplicateValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>> dict = new Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>>();
            dict[new InternedKey<ReadOnlyMemory<byte>>(1)] = Encoding.UTF8.GetBytes("One");
            dict[new InternedKey<ReadOnlyMemory<byte>>(2)] = Encoding.UTF8.GetBytes("One");
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_ReliablyConstructsTree()
        {
            IRandom random = new FastRandom(81542);
            StringBuilder builder = new StringBuilder();
            HashSet<string> existingStrings = new HashSet<string>();
            Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>> dict = new Dictionary<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Byte_Linear_RedundantOrdinals()
        {
