...
namespace Durandal.Internal.CoreOntology.SchemaDotOrg
{
    ...
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/AdministrativeArea", "http://schema.org/Place", "http://schema.org/Thing" };

        public City(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/City", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public City(Entity castFrom) : base(castFrom, "http://schema.org/City") { Initialize(); }
