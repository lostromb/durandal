...
{
    [TestClass]
    public class Test_BasicInternalizer_CharIgnoreCase
    {
        [TestMethod]
        public void Test_BasicInternalizer_CharIgnoreCase_Basic()
        {
            BasicInternalizer_CharIgnoreCase internalizer = new BasicInternalizer_CharIgnoreCase(new InternedKeySource<ReadOnlyMemory<char>>());
        ...
        [TestMethod]
        public void Test_BasicInternalizer_CharIgnoreCase_Random()
        {
        ...
        [TestMethod]
        public void Test_BasicInternalizer_CharIgnoreCase_NullValueSource()
        {
            try
            {
                BasicInternalizer_CharIgnoreCase internalizer = new BasicInternalizer_CharIgnoreCase(null);
        ...
        [TestMethod]
        public void Test_BasicInternalizer_CharIgnoreCase_ContainsEmpty()
        {
            BasicInternalizer_CharIgnoreCase internalizer = new BasicInternalizer_CharIgnoreCase(new InternedKeySource<ReadOnlyMemory<char>>());
        ...
        [TestMethod]
        public void Test_BasicInternalizer_CharIgnoreCase_ZeroZeroIsAllowed()
        {
            BasicInternalizer_CharIgnoreCase internalizer = new BasicInternalizer_CharIgnoreCase(new InternedKeySource<ReadOnlyMemory<char>>());
        ...
        [TestMethod]
        public void Test_BasicInternalizer_CharIgnoreCase_RedundantOrdinals()
        {
            BasicInternalizer_CharIgnoreCase internalizer = new BasicInternalizer_CharIgnoreCase(new UnitTestInternedKeySource<ReadOnlyMemory<char>>(5));
        ...
        [TestMethod]
        public void Test_BasicInternalizer_CharIgnoreCase_CrcHashCollisions()
        {
            BasicInternalizer_CharIgnoreCase internalizer = new BasicInternalizer_CharIgnoreCase(new InternedKeySource<ReadOnlyMemory<char>>());
        ...
        [TestMethod]
        [Conditional("DEBUG")]
        public void Test_BasicInternalizer_CharIgnoreCase_NegativeOrdinals()
        {
            UnitTestInternedKeySource<ReadOnlyMemory<char>> keySource = new UnitTestInternedKeySource<ReadOnlyMemory<char>>(-1);
            BasicInternalizer_CharIgnoreCase internalizer = new BasicInternalizer_CharIgnoreCase(keySource);
        ...
        [TestMethod]
        public void Test_BasicInternalizer_CharIgnoreCase_CaseSensitivity()
        {
            BasicInternalizer_CharIgnoreCase internalizer = new BasicInternalizer_CharIgnoreCase(new InternedKeySource<ReadOnlyMemory<char>>());
