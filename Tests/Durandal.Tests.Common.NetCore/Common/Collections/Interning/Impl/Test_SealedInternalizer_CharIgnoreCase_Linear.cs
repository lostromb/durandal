...
{
    [TestClass]
    public class Test_SealedInternalizer_CharIgnoreCase_Linear
    {
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_Basic()
        {
            ...
            SealedInternalizer_CharIgnoreCase_Linear internalizer = new SealedInternalizer_CharIgnoreCase_Linear(dict);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_Random()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_NullInput()
        {
            try
            {
                SealedInternalizer_CharIgnoreCase_Linear internalizer = new SealedInternalizer_CharIgnoreCase_Linear(null);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_ContainsEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_ZeroZeroIsAllowed()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_ContainsMultipleEmptyValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            dict[new InternedKey<ReadOnlyMemory<char>>(1)] = new char[0];
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_DoesntContainEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_DoesntContainEmpty2()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_NoInputs()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            SealedInternalizer_CharIgnoreCase_Linear internalizer = new SealedInternalizer_CharIgnoreCase_Linear(dict);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_ThrowsExceptionOnDuplicateValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            dict[new InternedKey<ReadOnlyMemory<char>>(1)] = "One".AsMemory();
            dict[new InternedKey<ReadOnlyMemory<char>>(2)] = "One".AsMemory();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_ReliablyConstructsTree()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_RedundantOrdinals()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_Linear_CaseSensitivity()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
