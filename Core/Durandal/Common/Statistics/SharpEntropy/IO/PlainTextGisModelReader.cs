...
namespace Durandal.Common.Statistics.SharpEntropy.IO
{
	...
	public class PlainTextGisModelReader : GisModelReader
	{
        ...
        public PlainTextGisModelReader(StreamReader reader, ICompactIndex<string> stringIndex)
            : base(stringIndex)
		{
			using (mInput = reader)
			{
		...
		{
            return float.Parse(mInput.ReadLine(), System.Globalization.CultureInfo.InvariantCulture);
		}
