...
namespace ManagedBass
{
    ...
    public struct DeviceInfo
    {
        ...
        public bool IsDefault
        {
            get
            {
                return flags.HasFlag(DeviceInfoFlags.Default);
            }
        }
        ...
        public bool IsEnabled
        {
            get
            {
                return flags.HasFlag(DeviceInfoFlags.Enabled);
            }
        }
        ...
        public bool IsInitialized
        {
            get
            {
                return flags.HasFlag(DeviceInfoFlags.Initialized);
            }
        }
        ...
        public DeviceType Type
        {
            get
            {
                return (DeviceType)(flags & DeviceInfoFlags.TypeMask);
            }
        }
    }
}
