...
//   Input filename:  .\Durandal.BondProtocol.API.DialogAction.bond
//   Output filename: Durandal.BondProtocol.API.DialogAction_types.cs
//
...
namespace Durandal.Extensions.BondProtocol.API
{
    ...
    public partial class DialogAction
    {
        ...
        public DialogAction()
            : this("Durandal.Extensions.BondProtocol.API.DialogAction", "DialogAction")
        {}

        protected DialogAction(string fullName, string name)
        {
            Domain = "";
            Intent = "";
