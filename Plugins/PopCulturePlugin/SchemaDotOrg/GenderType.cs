...
{
    /// <summary>
    /// <para>GenderType</para>
    /// <para>An enumeration of genders.</para>
    /// </summary>
    internal class GenderType : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/Enumeration", "http://schema.org/Intangible", "http://schema.org/Thing" };

        public GenderType(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/GenderType", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public GenderType(Entity castFrom) : base(castFrom, "http://schema.org/GenderType") { Initialize(); }
