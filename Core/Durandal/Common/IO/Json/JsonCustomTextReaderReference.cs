...
namespace Durandal.Common.IO.Json
{
    ...
    public class JsonCustomTextReader : JsonReader, IJsonLineInfo
    {
        ...
        private LocalStringBuffer _stringBuffer;
        private LocalStringReference _stringReference;
        ...
        {
            reader.AssertNonNull(nameof(reader));
            _reader = reader;
            _lineNumber = 1;
        ...
        private void EnsureBufferNotEmpty()
        {
            ...
            {
                _stringBuffer = new LocalStringBuffer(_arrayPool, 1024);
            }
        }
        ...
        {
            ArrayExtensions.MemCopy(src, srcOffset, dst, dstOffset, count);
        }
                ...
                switch (CurrentState)
                {
                    ...
                    case State.Finished:
                        if (EnsureChars(0, false))
                        {
                            ...
                            throw new Exception(); // throw JsonReaderException.Create(this, "Additional text encountered after finished reading JSON content: {0}.".FormatWith(CultureInfo.InvariantCulture, _chars[_charPos]));
                        }
                        SetToken(JsonToken.None);
                        return false;
                    default:
                        throw new Exception(); // throw JsonReaderException.Create(this, "Unexpected state: {0}.".FormatWith(CultureInfo.InvariantCulture, CurrentState));
                }
            }
        }
                        ...
                        switch (currentChar)
                        {
                            ...
                            case '\'':
                                ...
                                if (isWrapped)
                                {
                                    ...
                                    {
                                        throw new Exception(); // throw JsonReaderException.Create(this, "Error reading bytes. Unexpected token: {0}.".FormatWith(CultureInfo.InvariantCulture, TokenType));
                                    }
                                    SetToken(JsonToken.Bytes, data, false);
                                }
                                return data;
                            ...
                            case ']':
                                _charPos++;
                                if (CurrentState == State.Array || CurrentState == State.ArrayStart || CurrentState == State.PostValue)
                                {
        ...
        {
            return new Exception(); // JsonReaderException.Create(this, "Unexpected character encountered while parsing value: {0}.".FormatWith(CultureInfo.InvariantCulture, c));
        }
        ...
        private void ProcessValueComma()
        {
            ...
            if (CurrentState != State.PostValue)
            {
                ...
                Exception ex = CreateUnexpectedCharacterException(',');
        ...
        private void FinishReadStringIntoBuffer(int charPos, int initialPosition, int lastWritePosition)
        {
            ...
            {
                _stringReference = new LocalStringReference(_chars, initialPosition, charPos - initialPosition);
            }
            else
            {
                EnsureBufferNotEmpty();
                ...
                _stringReference = new LocalStringReference(_stringBuffer.InternalBuffer, 0, _stringBuffer.Position);
            }
        ...
        private char ConvertUnicode(bool enoughChars)
        {
            ...
            if (enoughChars)
            {
                ...
                {
                    throw new Exception(); // throw JsonReaderException.Create(this, @"Invalid Unicode escape sequence: \u{0}.".FormatWith(CultureInfo.InvariantCulture, new string(_chars, _charPos, 4)));
                }
            }
            else
            {
                throw new Exception(); // throw JsonReaderException.Create(this, "Unexpected end while parsing Unicode escape sequence.");
            }
        }
        ...
        private bool ReadNumberCharIntoBuffer(char currentChar, int charPos)
        {
            switch (currentChar)
            {
                ...
                default:
                    ...
                    throw new Exception(); // throw JsonReaderException.Create(this, "Unexpected character encountered while parsing number: {0}.".FormatWith(CultureInfo.InvariantCulture, currentChar));
            }
        }
        ...
        {
            _stringBuffer.Position = 0;
            _stringReference = new LocalStringReference();
        }
                ...
                switch (currentChar)
                {
                    ...
                    default:
                        ...
                        else
                        {
                            ...
                            throw new Exception(); // throw JsonReaderException.Create(this, "After parsing a value an unexpected character was encountered: {0}.".FormatWith(CultureInfo.InvariantCulture, currentChar));
                        }
                        break;
                }
            }
        ...
        private bool ParseProperty()
        {
            ...
            {
                throw new Exception(); // throw JsonReaderException.Create(this, "Invalid property identifier character: {0}.".FormatWith(CultureInfo.InvariantCulture, _chars[_charPos]));
            }
            ...
            if (_chars[_charPos] != ':')
            {
                throw new Exception(); // throw JsonReaderException.Create(this, "Invalid character after parsing property name. Expected ':' but got: {0}.".FormatWith(CultureInfo.InvariantCulture, _chars[_charPos]));
            }
            ...
            while (true)
            {
                ...
                if (currentChar == '\0')
                {
                    if (_charsUsed == _charPos)
                    {
                        if (ReadData(true) == 0)
                        {
                            throw new Exception(); // throw JsonReaderException.Create(this, "Unexpected end while parsing unquoted property name.");
                        }

                        continue;
                    }

                    _stringReference = new LocalStringReference(_chars, initialPosition, _charPos - initialPosition);
                    return;
                }
        ...
        private bool ReadUnquotedPropertyReportIfDone(char currentChar, int initialPosition)
        {
            ...
            throw new Exception(); // throw JsonReaderException.Create(this, "Invalid JavaScript property identifier character: {0}.".FormatWith(CultureInfo.InvariantCulture, currentChar));
        }
        ...
        private void ParseConstructor()
        {
            ...
            if (MatchValueWithTrailingSeparator("new"))
            {
                ...
                while (true)
                {
                    ...
                    if (currentChar == '\0')
                    {
                        if (_charsUsed == _charPos)
                        {
                            if (ReadData(true) == 0)
                            {
                                throw new Exception(); // throw JsonReaderException.Create(this, "Unexpected end while parsing constructor.");
                            }
                        }
                        else
                        {
                    ...
                    {
                        throw new Exception(); // throw JsonReaderException.Create(this, "Unexpected character while parsing constructor: {0}.".FormatWith(CultureInfo.InvariantCulture, currentChar));
                    }
                }

                _stringReference = new LocalStringReference(_chars, initialPosition, endPosition - initialPosition);
                ...
                if (_chars[_charPos] != '(')
                {
                    throw new Exception(); // throw JsonReaderException.Create(this, "Unexpected character while parsing constructor: {0}.".FormatWith(CultureInfo.InvariantCulture, _chars[_charPos]));
                }
            ...
            {
                throw new Exception(); // throw JsonReaderException.Create(this, "Unexpected content while parsing JSON.");
            }
        }
        ...
        private void ParseReadNumber(ReadType readType, char firstChar, int initialPosition)
        {
            ...
            switch (readType)
            {
                ...
                case ReadType.ReadAsInt64:
                    ...
                    break;
                default:
                    throw new Exception(); // throw JsonReaderException.Create(this, "Cannot read number value as type.");
            }
        ...
        private Exception ThrowReaderError(string message, Exception ex = null)
        {
            SetToken(JsonToken.Undefined, null, false);
            return new Exception(); // JsonReaderException.Create(this, message, ex);
        }
        ...
        private void ParseComment(bool setToken)
        {
            ...
            {
                throw new Exception(); // throw JsonReaderException.Create(this, "Unexpected end while parsing comment.");
            }
            ...
            {
                throw new Exception(); // throw JsonReaderException.Create(this, "Error parsing comment. Expected: *, got {0}.".FormatWith(CultureInfo.InvariantCulture, _chars[_charPos]));
            }
        ...
        private void ParseTrue()
        {
            ...
            {
                throw new Exception(); // throw JsonReaderException.Create(this, "Error parsing boolean value.");
            }
        }
        ...
        private void ParseNull()
        {
            ...
            {
                throw new Exception(); // throw JsonReaderException.Create(this, "Error parsing null value.");
            }
        }
        ...
        private void ParseUndefined()
        {
            ...
            {
                throw new Exception(); // throw JsonReaderException.Create(this, "Error parsing undefined value.");
            }
        }
        ...
        private object ParseNumberNegativeInfinity(ReadType readType, bool matched)
        {
            if (matched)
            {
                ...
                throw new Exception(); // throw JsonReaderException.Create(this, "Cannot read -Infinity value.");
            }

            throw new Exception(); // throw JsonReaderException.Create(this, "Error parsing -Infinity value.");
        }
        ...
        private object ParseNumberNaN(ReadType readType, bool matched)
        {
            if (matched)
            {
                ...
                throw new Exception(); // throw JsonReaderException.Create(this, "Cannot read NaN value.");
            }

            throw new Exception(); // throw JsonReaderException.Create(this, "Error parsing NaN value.");
        }
