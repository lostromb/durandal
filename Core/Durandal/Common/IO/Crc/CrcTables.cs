...
{
    /// <summary>
    /// Static data tables for the CRC32C algorithm.
    /// Marked public so they can be reused by other implementations if necessary.
    /// </summary>
    public static class CrcTables
    {
        public static readonly uint[][] CrcTable32 = new uint[16][]
        {
            new uint[256] {
        ...
        public static readonly uint[][] LongShifts32 = new uint[4][] {
            new uint[256] {
        ...
        public static readonly uint[][] ShortShifts32 = new uint[4][] {
            new uint[256] {
