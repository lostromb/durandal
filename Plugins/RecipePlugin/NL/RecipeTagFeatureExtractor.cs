namespace Durandal.Plugins.Recipe.NL
{
    ...
    public class RecipeTagFeatureExtractor
    {
        public RecipeTagFeatureExtractor()
        {
        }
        ...
        public string[] ExtractFeatures(Sentence input, string[][] tagHistory, int wordIndex)
        {
            ...
            Sentence normalizedSentence = new Sentence();
        ...
        public void ExtractTrainingFeatures(IEnumerable<string> trainingLines, TrainingDataList<TagFeature> output, IWordBreaker wordBreaker, ISet<string> possibleTags)
        {
