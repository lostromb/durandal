...
namespace Durandal.Common.Speech.Triggers.Sphinx.Internal.CPlusPlus
{
    internal static class stdio
    {
        ...
        /// <returns></returns>
        internal static int sscanf_s_n(Pointer<byte> source, Pointer<byte> output, out int len)
        {
        ...
        /// <param name="output"></param>
        /// <returns></returns>
        internal static int sscanf_s(Pointer<byte> source, Pointer<byte> output)
        {
            int dummy;
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        internal static int sscanf_d_n(Pointer<byte> source, out int d, out int n)
        {
            string bigstr = cstring.FromCString(source);
        ...
        internal static int sscanf_f(Pointer<byte> source, out double d)
        {
            string bigstr = cstring.FromCString(source);
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        internal static int sscanf_d(Pointer<byte> source, out int n)
        {
            int dummy;
        ...
        /// <param name="d"></param>
        /// <returns></returns>
        internal static int sscanf_u(Pointer<byte> source, out uint d)
        {
            string bigstr = cstring.FromCString(source);
            Regex matcher = new Regex("^\\s*([0-9]+)");
            Match m = matcher.Match(bigstr);
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        internal static int sscanf_d_s(Pointer<byte> source, out int d, Pointer<byte> s)
        {
            throw new NotImplementedException();
        }
        
        internal static int sprintf(Pointer<byte> target, string str)
        {
