namespace Durandal.Service
{
    ...
    public static class BigDialogMess
    {
        ...
        public static async Task RunDialogService(string[] programArgs)
        {
            ...
            SystemAESDelegates aesImpl = null;
            ...
            RawTcpSocketServer socketServer = null;
            IDurandalPluginProvider pluginProvider = null;
            DialogServiceCollection allServices = null;
            DialogWebService dialogWebService = null;
            IHttpClient dialogHttpClient = null;
            IDialogClient dialogClient = null;
            ...
            try
            {
                ...
                AssemblyReflector.ApplyAccelerators(typeof(NativeSpeexResamplerAccelerator).Assembly, coreLogger); // Extensions.NativeAudio
                ...
                List<IDialogTransportProtocol> dialogWebProtocols = new List<IDialogTransportProtocol>()
                {
                    ...
                    new DialogZstdJsonTransportProtocol(),
                    new DialogZstdBondTransportProtocol(),
                    new DialogZstdDictJsonTransportProtocolV1(),
                    new DialogZstdDictBondTransportProtocolV1(),
                };
                ...
                Task backgroundJitTask = Jitter.JitAssembly(coreLogger.Clone("JIT"), Assembly.GetEntryAssembly(), TimeSpan.FromSeconds(10));
                ...
                await backgroundJitTask.ConfigureAwait(false);
            }
            finally
            {
                engine?.Dispose();
