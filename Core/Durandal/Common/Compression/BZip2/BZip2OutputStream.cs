...
namespace Durandal.Common.Compression.BZip2
{
    ...
    public class BZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new Durandal.Common.Compression.BZip2.BZip2OutputStream(output))
        ///           {
        ...
        ///   </code>
        /// </example>
        public BZip2OutputStream(Stream output, ILogger logger)
            : this(output, BZip2.MaxBlockSize, false, logger)
        {
        }
        ...
        /// </param>
        /// <param name="logger"></param>
        public BZip2OutputStream(Stream output, int blockSize, ILogger logger)
            : this(output, blockSize, false, logger)
        {
        }
        ...
        /// </param>
        /// <param name="logger"></param>
        public BZip2OutputStream(Stream output, bool leaveOpen, ILogger logger)
            : this(output, BZip2.MaxBlockSize, leaveOpen, logger)
        {
        }
        ...
        /// </param>
        /// <param name="logger"></param>
        public BZip2OutputStream(Stream output, int blockSize, bool leaveOpen, ILogger logger)
        {
        ...
        public override bool CanWrite
        {
            get
            {
                if (this.output == null) throw new ObjectDisposedException(nameof(BZip2OutputStream));
