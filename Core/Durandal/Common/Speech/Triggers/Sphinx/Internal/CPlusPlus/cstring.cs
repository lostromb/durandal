...
namespace Durandal.Common.Speech.Triggers.Sphinx.Internal.CPlusPlus
{
    internal static class cstring
    {
        ...
        /// <returns></returns>
        internal static uint strlen(Pointer<byte> str)
        {
            uint returnVal;
        ...
        internal static int strcmp(Pointer<byte> one, Pointer<byte> two)
        {
        ...
        /// zero .Deref. the strings are equal
        /// positive .Deref. the first character that does not match has a greater value in ptr1 than in ptr2</returns>
        internal static int strncmp(Pointer<byte> one, Pointer<byte> two, uint n)
        {
            for (uint c = 0; c < n; c++)
            {
                if (one[c] == 0)
        ...
        internal static Pointer<byte> strtok(Pointer<byte> str, Pointer<byte> delimiters)
        {
            if (str.IsNull)
            {
                str = _last_strtok;
        ...
        internal static Pointer<byte> strchr(Pointer<byte> str, byte character)
        {
            uint c = 0;
            while (true)
            {
        ...
        internal static Pointer<byte> strrchr(Pointer<byte> str, byte character)
        {
        ...
        internal static uint strspn(Pointer<byte> one, Pointer<byte> two)
        {
            uint c = 0;
        ...
        internal static Pointer<byte> strcpy(Pointer<byte> dest, Pointer<byte> source)
        {
            uint c;
        ...
        /// <returns>destination is returned</returns>
        internal static Pointer<byte> strncpy(Pointer<byte> dest, Pointer<byte> source, uint n)
        {
            uint c;
        ...
        /// <returns>destination is returned.</returns>
        internal static Pointer<byte> strncat(Pointer<byte> dest, Pointer<byte> source, uint num)
        {
        ...
        internal static Pointer<byte> strstr(Pointer<byte> str1, Pointer<byte> str2)
        {
        ...
        internal static int atoi(Pointer<byte> str)
        {
            int cursor = 0;
        ...
        /// <returns></returns>
        internal static Pointer<byte> ToCString(string input)
        {
            byte[] encoded = Encoding.UTF8.GetBytes(input);
            byte[] nullTerminated = new byte[encoded.Length + 1];
            nullTerminated[encoded.Length] = 0;
            ArrayExtensions.MemCopy(encoded, 0, nullTerminated, 0, encoded.Length);
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        internal static string FromCString(Pointer<byte> input)
        {
        ...
        internal static string FromCString(Pointer<byte> input, uint length)
        {
            byte[] encoded = new byte[length];
            input.MemCopyTo(encoded, 0, encoded.Length);
            return Encoding.UTF8.GetString(encoded, 0, encoded.Length);
