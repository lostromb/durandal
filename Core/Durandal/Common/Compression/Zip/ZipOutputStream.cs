...
namespace Durandal.Common.Compression.Zip
{
    ...
    ///   through the stream.  You may wish to set the ParallelDeflateThreshold property to zero, if you are compressing
    ...
    public class ZipOutputStream : Stream
    {
        ...
        /// </code>
        /// </example>
        public ZipOutputStream(ILogger logger, IFileSystem fileSystem, Stream stream) : this(logger, fileSystem, stream, false) { }
        ...
        /// </code>
        /// </example>
        public ZipOutputStream(ILogger logger, VirtualPath fileName, IFileSystem fileSystem)
        {
            Stream stream = fileSystem.OpenStream(fileName, FileOpenMode.Create, FileAccessMode.ReadWrite);// File.Open(fileName, FileMode.Create, FileAccess.ReadWrite, FileShare.None);
            _Init(logger, fileSystem, stream, false, fileName);
        ...
        /// </param>
        public ZipOutputStream(ILogger logger, IFileSystem fileSystem, Stream stream, bool leaveOpen)
        {
            _Init(logger, fileSystem, stream, leaveOpen, null);
            DebugMemoryLeakTracer.TraceDisposableItemCreated(this);
        }

        private void _Init(ILogger logger, IFileSystem fileSystem, Stream stream, bool leaveOpen, VirtualPath name)
        {
            // workitem 9307
            _logger = logger;
            ...
            Strategy = Durandal.Common.Compression.ZLib.CompressionStrategy.Default;
            _name = name ?? new VirtualPath("\\stream");
        }
        ...
        ///   cref="Durandal.Common.Compression.ZLib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = Durandal.Common.Compression.Zip.ZipOutputStream.DefaultEncoding;
        ...
        /// known as IBM437.
        /// </summary>
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.ProvisionalAlternateEncoding"/>
        public static System.Text.Encoding DefaultEncoding
        {
            get
            {
                return SharedUtilities.GetIBM437Encoding();
            }
        }
        ...
        public ZipEntry PutNextEntry(String entryName)
        {
            ...
            _FinishCurrentEntry();
            _currentEntry = ZipEntry.CreateForZipOutputStream(_logger, _fileSystem, entryName);
        ...
        private System.Text.Encoding _alternateEncoding
            = SharedUtilities.GetIBM437Encoding(); // default = IBM437
        ...
        private Durandal.Common.Compression.CrcCalculatorStream _entryOutputStream;
