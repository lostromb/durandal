	...
	class Agc
	{
		...
		class DigitalAgc
		{
												   ...
												   short lowlevelSignal)
			{
                ...
                ArrayExtensions.MemCopy(in_near_arr, in_near_ptr, out_arr, out_ptr, 10 * L);
				...
				if (FS == 32000)
				{
                    ArrayExtensions.MemCopy(in_near_H_arr, in_near_H_ptr, out_H_arr, out_H_ptr, 10 * L);
...
*/
		int WebRtcAgc_AddMic(short[] in_mic, short[] in_mic_H, short samples)
		{
			...
			for (i = 0; i < WebRtcUtil.WEBRTC_SPL_RSHIFT_W16(M, 1); i++)
			{
				...
				{
                    ArrayExtensions.MemCopy(in_mic, i * 16, tmp_speech, 0, 16);
 ...
 */
		...
		fprintf(this.fpt,
            ...
            ArrayExtensions.MemCopy(in_near, 0, outArray, 0, samples);
			// Array.Copy(in_near, 0, outArray, 0, samples);
			//memcpy(outArray, in_near, samples * sizeof(short));
			if (fs == 32000)
			{
                ArrayExtensions.MemCopy(in_near_H, 0, out_H, 0, samples);
