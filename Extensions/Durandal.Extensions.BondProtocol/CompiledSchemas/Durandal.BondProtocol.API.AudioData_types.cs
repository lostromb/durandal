...
//   Input filename:  .\Durandal.BondProtocol.API.AudioData.bond
//   Output filename: Durandal.BondProtocol.API.AudioData_types.cs
//
...
namespace Durandal.Extensions.BondProtocol.API
{
    ...
    public partial class AudioData
    {
        ...
        public AudioData()
            : this("Durandal.Extensions.BondProtocol.API.AudioData", "AudioData")
        {}

        protected AudioData(string fullName, string name)
        {
