...
namespace Durandal.Common.Statistics.SharpEntropy
{
	...
	public class PatternedPredicate
	{
		...
		/// </param>
        protected internal PatternedPredicate(int outcomePattern, float[] parameters)
		{
		...
		/// Array of parameters for this predicate.
		/// </param>
        protected internal PatternedPredicate(Compact<string> name, float[] parameters)
		{
			mName = name;
			mParameters = parameters;
		}
