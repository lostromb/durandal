#pragma warning disable CS0169 // Field is assigned a value but never used
		...
		public void WebRtcAec_Process(short[] nearend, short streamDelayMs, int skew)
		{
			...
			else
			{
				...
				for (int i = 0; i < nFrames; i++)
				{
                    ...
                    ArrayExtensions.MemCopy(nearend, aecConfig.SamplesPerFrame * i, nearend80, 0, aecConfig.SamplesPerFrame);
					aec.ProcessFrame(nearend80, farend, nearend80, knownDelay);
                    ArrayExtensions.MemCopy(nearend80, 0, nearend, aecConfig.SamplesPerFrame * i, aecConfig.SamplesPerFrame);
				}
			}
		}
...
#pragma warning restore CS0169 //Field is assigned a value but never used