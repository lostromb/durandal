...
namespace ManagedBass
{
    ...
    public static class BitHelper
    {
        ...
        /// </summary>
        public static int HiDword(this long pDWord)
        {
        ...
        /// </summary>
        public static int LoDword(this long pDWord)
        {
            return (int)pDWord;
        }
        ...
        /// </summary>
        public static short HiWord(this int pDWord)
        {
        ...
        /// The return value is the low-order word of the specified value.
        /// </summary>
        public static short LoWord(this int pDWord)
        {
            return (short)pDWord;
        }
        ...
        /// </summary>
        public static byte HiByte(this short pWord)
        {
        ...
        /// </summary>
        public static byte LoByte(this short pWord)
        {
            return (byte)pWord;
        }
