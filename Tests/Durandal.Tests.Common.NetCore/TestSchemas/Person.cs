...
namespace Durandal.Tests.TestSchemas
{
    ...
    public class Person : Entity
    {
        ...
        private void Initialize()
        {
            ...
            Height_as_Distance = new IdentifierValue<Distance>(_context, EntityId, "height");
            Height_as_QuantitativeValue = new IdentifierValue<QuantitativeValue>(_context, EntityId, "height");
            ...
            Weight = new IdentifierValue<QuantitativeValue>(_context, EntityId, "weight");
        ...
        /// </summary>
        public IdentifierValue<Distance> Height_as_Distance { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Person)</para>
        /// <para>The height of the item.</para>
        /// </summary>
        public IdentifierValue<QuantitativeValue> Height_as_QuantitativeValue { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Person)</para>
        ...
        /// </summary>
        public IdentifierValue<QuantitativeValue> Weight { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/Person)</para>
        /// <para>A contact point for a person or organization.</para>
        /// </summary>
