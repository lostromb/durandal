...
namespace Durandal.Common.Speech.Triggers.Sphinx.Internal
{
    internal static class StringFuncs
    {
        ...
        internal static Pointer<byte> string_trim(Pointer<byte> str, string_edge_e which)
        {
            uint len;
        ...
        internal static double atof_c(Pointer<byte> str)
        {
        ...
        internal static int isspace_c(byte ch)
        {
            if (ch == ' ' || ch == '\t' || ch == '\n' || ch == '\r')
                return 1;
            return 0;
        ...
        internal static int str2words(Pointer<byte> line, Pointer<Pointer<byte>> ptr, int max_ptr)
        {
            int i, n;
