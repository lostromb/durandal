...
namespace Durandal.Common.Compression.Zip
{
    ...
    ///   cref="Durandal.Common.Compression.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="Durandal.Common.Compression.Zip.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.SetCompression"/>
    public delegate Durandal.Common.Compression.ZLib.CompressionLevel SetCompressionCallback(VirtualPath localFileName, string fileNameInArchive);
    ...
    public class ZipProgressEventArgs : EventArgs
    {
        ...
        private VirtualPath _archiveName;
        ...
        internal ZipProgressEventArgs(VirtualPath archiveName, ZipProgressEventType flavor)
        {
        ...
        /// </summary>
        public VirtualPath ArchiveName
        {
    ...
    public class ReadProgressEventArgs : ZipProgressEventArgs
    {
        ...
        private ReadProgressEventArgs(VirtualPath archiveName, ZipProgressEventType flavor)
            : base(archiveName, flavor)
        { }

        internal static ReadProgressEventArgs Before(VirtualPath archiveName, int entriesTotal)
        {
        ...
        internal static ReadProgressEventArgs After(VirtualPath archiveName, ZipEntry entry, int entriesTotal)
        {
        ...
        internal static ReadProgressEventArgs Started(VirtualPath archiveName)
        {
            var x = new ReadProgressEventArgs(archiveName, ZipProgressEventType.Reading_Started);
            return x;
        }

        internal static ReadProgressEventArgs ByteUpdate(VirtualPath archiveName, ZipEntry entry, Int64 bytesXferred, Int64 totalBytes)
        {
        ...
        internal static ReadProgressEventArgs Completed(VirtualPath archiveName)
        {
    ...
    public class AddProgressEventArgs : ZipProgressEventArgs
    {
        ...
        private AddProgressEventArgs(VirtualPath archiveName, ZipProgressEventType flavor)
            : base(archiveName, flavor)
        { }

        internal static AddProgressEventArgs AfterEntry(VirtualPath archiveName, ZipEntry entry, int entriesTotal)
        {
        ...
        internal static AddProgressEventArgs Started(VirtualPath archiveName)
        {
            var x = new AddProgressEventArgs(archiveName, ZipProgressEventType.Adding_Started);
            return x;
        }

        internal static AddProgressEventArgs Completed(VirtualPath archiveName)
        {
    ...
    public class SaveProgressEventArgs : ZipProgressEventArgs
    {
        ...
        internal SaveProgressEventArgs(VirtualPath archiveName, bool before, int entriesTotal, int entriesSaved, ZipEntry entry)
        ...
        internal SaveProgressEventArgs(VirtualPath archiveName, ZipProgressEventType flavor)
            : base(archiveName, flavor)
        { }


        internal static SaveProgressEventArgs ByteUpdate(VirtualPath archiveName, ZipEntry entry, Int64 bytesXferred, Int64 totalBytes)
        {
        ...
        internal static SaveProgressEventArgs Started(VirtualPath archiveName)
        {
            var x = new SaveProgressEventArgs(archiveName, ZipProgressEventType.Saving_Started);
            return x;
        }

        internal static SaveProgressEventArgs Completed(VirtualPath archiveName)
        {
    ...
    public class ExtractProgressEventArgs : ZipProgressEventArgs
    {
        ...
        internal ExtractProgressEventArgs(VirtualPath archiveName, bool before, int entriesTotal, int entriesExtracted, ZipEntry entry, VirtualPath extractLocation)
        ...
        internal ExtractProgressEventArgs(VirtualPath archiveName, ZipProgressEventType flavor)
            : base(archiveName, flavor)
        { }
        ...
        internal static ExtractProgressEventArgs BeforeExtractEntry(VirtualPath archiveName, ZipEntry entry, VirtualPath extractLocation)
        {
        ...
        internal static ExtractProgressEventArgs ExtractExisting(VirtualPath archiveName, ZipEntry entry, VirtualPath extractLocation)
        {
            var x = new ExtractProgressEventArgs
                {
                    ArchiveName = archiveName,
        ...
        internal static ExtractProgressEventArgs AfterExtractEntry(VirtualPath archiveName, ZipEntry entry, VirtualPath extractLocation)
        {
            var x = new ExtractProgressEventArgs
                {
                    ArchiveName = archiveName,
        ...
        internal static ExtractProgressEventArgs ExtractAllStarted(VirtualPath archiveName, VirtualPath extractLocation)
        {
        ...
        internal static ExtractProgressEventArgs ExtractAllCompleted(VirtualPath archiveName, VirtualPath extractLocation)
        {
        ...
        internal static ExtractProgressEventArgs ByteUpdate(VirtualPath archiveName, ZipEntry entry, Int64 bytesWritten, Int64 totalBytes)
        {
        ...
        /// </summary>
        public VirtualPath ExtractLocation
        {
            get { return _target; }
        }
    ...
    public class ZipErrorEventArgs : ZipProgressEventArgs
    {
        ...
        internal static ZipErrorEventArgs Saving(VirtualPath archiveName, ZipEntry entry, Exception exception)
        {
