...
namespace Durandal.Common.Collections.Interning.Impl
{
    ...
    /// </summary>
    internal class SealedInternalizer_Char_PerfectHash_Unchecked : ISealedPrimitiveInternalizer<char>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="SealedInternalizer_Char_PerfectHash_Unchecked"/> from a collection of already established
        ...
        public SealedInternalizer_Char_PerfectHash_Unchecked(IReadOnlyCollection<KeyValuePair<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>> entries)
        {
            if (entries == null)
            {
        ...
        public InternalizerFeature Features => InternalizerFeature.OnlyMatchesWithinSet;
