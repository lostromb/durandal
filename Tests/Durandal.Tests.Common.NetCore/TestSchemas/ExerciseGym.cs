...
{
    /// <summary>
    /// <para>ExerciseGym</para>
    /// <para>A gym.</para>
    /// </summary>
    public class ExerciseGym : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/SportsActivityLocation", "http://schema.org/LocalBusiness", "http://schema.org/Place", "http://schema.org/Organization", "http://schema.org/Thing" };

        public ExerciseGym(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/ExerciseGym", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public ExerciseGym(Entity castFrom) : base(castFrom, "http://schema.org/ExerciseGym") { Initialize(); }
