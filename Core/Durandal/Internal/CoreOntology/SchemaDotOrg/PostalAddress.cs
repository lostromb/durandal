...
namespace Durandal.Internal.CoreOntology.SchemaDotOrg
{
    ...
    /// </summary>
    internal class PostalAddress : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/ContactPoint", "http://schema.org/StructuredValue", "http://schema.org/Intangible", "http://schema.org/Thing" };

        public PostalAddress(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/PostalAddress", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public PostalAddress(Entity castFrom) : base(castFrom, "http://schema.org/PostalAddress") { Initialize(); }
        ...
        {
            PostOfficeBoxNumber = new TextValue(_context, EntityId, "postOfficeBoxNumber");
            StreetAddress = new TextValue(_context, EntityId, "streetAddress");
            ...
            AddressRegion = new TextValue(_context, EntityId, "addressRegion");
            PostalCode = new TextValue(_context, EntityId, "postalCode");
            AddressLocality = new TextValue(_context, EntityId, "addressLocality");
        ...
        /// <summary>
        /// <para>(From http://schema.org/PostalAddress)</para>
        /// <para>The post office box number for PO box addresses.</para>
        /// </summary>
        public TextValue PostOfficeBoxNumber { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/PostalAddress)</para>
        /// <para>The street address. For example, 1600 Amphitheatre Pkwy.</para>
        /// </summary>
        public TextValue StreetAddress { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/PostalAddress)</para>
        ...
        /// </summary>
        public TextValue AddressRegion { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/PostalAddress)</para>
        ...
        /// </summary>
        public TextValue AddressLocality { get; private set; }
        /// <summary>
