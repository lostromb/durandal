...
namespace ManagedBass
{
    ...
    public class RecordDevice : IDisposable
    {
        ...
        public static int Count
        {
            get
            {
                return Bass.RecordingDeviceCount;
            }
        }
        ...
        public DeviceInfo Info
        {
            get
            {
                return Bass.RecordGetDeviceInfo(Index);
            }
        }
        ...
        /// </summary>
        public static RecordDevice Default
        {
            get
            {
        ...
        /// </summary>
        public static RecordInfo CurrentInfo
        {
            get
            {
                return Bass.RecordingInfo;
            }
        }
