...
{
    internal static class CommandLineMacro
    {
...
//#define SEED  -1
        ...
        internal static List<arg_t> POCKETSPHINX_OPTIONS()
        {
            List<arg_t> args = new List<arg_t>();
            args.FastAddRangeList(POCKETSPHINX_DEBUG_OPTIONS());
            args.FastAddRangeList(POCKETSPHINX_BEAM_OPTIONS());
            args.FastAddRangeList(POCKETSPHINX_SEARCH_OPTIONS());
            args.FastAddRangeList(POCKETSPHINX_KWS_OPTIONS());
            args.FastAddRangeList(POCKETSPHINX_FSG_OPTIONS());
            args.FastAddRangeList(POCKETSPHINX_NGRAM_OPTIONS());
            args.FastAddRangeList(POCKETSPHINX_DICT_OPTIONS());
            args.FastAddRangeList(POCKETSPHINXacmod_OPTIONS());
            args.FastAddRangeList(waveform_to_cepstral_command_line_macro());
            args.FastAddRangeList(cepstral_to_feature_command_line_macro());
            args.Add(null);
            return args;
        }

        internal static List<arg_t> POCKETSPHINX_DEBUG_OPTIONS()
        {
            List<arg_t> args = new List<arg_t>();
            args.Add(new arg_t()
            {
                name = cstring.ToCString("-logfn"),
                type = CommandLine.ARG_STRING,
        ...
        internal static List<arg_t> POCKETSPHINX_BEAM_OPTIONS()
        {
            List<arg_t> args = new List<arg_t>();
            args.Add(new arg_t()
            {
                name = cstring.ToCString("-beam"),
                type = CommandLine.ARG_FLOATING,
        ...
        internal static List<arg_t> POCKETSPHINX_SEARCH_OPTIONS()
        {
            List<arg_t> args = new List<arg_t>();
            args.Add(new arg_t()
            {
                name = cstring.ToCString("-compallsen"),
                type = CommandLine.ARG_BOOLEAN,
        ...
        internal static List<arg_t> POCKETSPHINX_KWS_OPTIONS()
        {
            List<arg_t> args = new List<arg_t>();
            args.Add(new arg_t()
            {
        ...
        internal static List<arg_t> POCKETSPHINX_FSG_OPTIONS()
        {
            List<arg_t> args = new List<arg_t>();
            return args;
        }

        internal static List<arg_t> POCKETSPHINX_NGRAM_OPTIONS()
        {
            List<arg_t> args = new List<arg_t>();
            return args;
        }

        internal static List<arg_t> POCKETSPHINX_DICT_OPTIONS()
        {
            List<arg_t> args = new List<arg_t>();
            args.Add(new arg_t()
            {
                name = cstring.ToCString("-dict"),
                type = CommandLine.REQARG_STRING,
                deflt = PointerHelpers.NULL<byte>(),
        ...
        internal static List<arg_t> POCKETSPHINXacmod_OPTIONS()
        {
            List<arg_t> args = new List<arg_t>();
            args.Add(new arg_t()
            {
        ...
        internal static List<arg_t> waveform_to_cepstral_command_line_macro()
        {
            List<arg_t> args = new List<arg_t>();
            args.Add(new arg_t()
            {
        ...
        internal static List<arg_t> cepstral_to_feature_command_line_macro()
        {
            List<arg_t> args = new List<arg_t>();
            args.Add(new arg_t()
            {
