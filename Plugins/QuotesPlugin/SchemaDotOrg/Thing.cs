...
namespace Durandal.Plugins.Quotes.SchemaDotOrg
{
    ...
    /// </summary>
    internal class Thing : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>();

        public Thing(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/Thing", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public Thing(Entity castFrom) : base(castFrom, "http://schema.org/Thing") { Initialize(); }
