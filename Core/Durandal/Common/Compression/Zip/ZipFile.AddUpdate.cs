...
namespace Durandal.Common.Compression.Zip
{
    public partial class ZipFile
    {
        ...
        public ZipEntry AddItem(VirtualPath fileOrDirectoryName)
        {
        ...
        /// </example>
        /// <returns>The <c>ZipEntry</c> added.</returns>
        public ZipEntry AddItem(VirtualPath fileOrDirectoryName, String directoryPathInArchive)
        {
            if (!_fileSystem.Exists(fileOrDirectoryName))
                throw new FileNotFoundException(String.Format("That file or directory ({0}) does not exist!",
                                                          fileOrDirectoryName.FullName));

            if (_fileSystem.WhatIs(fileOrDirectoryName) == ResourceType.Directory)
        ...
        public ZipEntry AddFile(VirtualPath fileName)
        {
        ...
        ///
        /// <returns>The <c>ZipEntry</c> corresponding to the file added.</returns>
        public ZipEntry AddFile(VirtualPath fileName, String directoryPathInArchive)
        {
            string nameInArchive = ZipEntry.NameInArchive(fileName, directoryPathInArchive);
            ZipEntry ze = ZipEntry.CreateFromFile(_logger, _fileSystem, fileName, nameInArchive);
        ...
        /// </code>
        /// </example>
        public void AddFiles(System.Collections.Generic.IEnumerable<VirtualPath> fileNames)
        {
        ...
        /// </param>
        ///
        public void UpdateFiles(System.Collections.Generic.IEnumerable<VirtualPath> fileNames)
        {
        ...
        ///   archive.
        /// </param>
        public void AddFiles(System.Collections.Generic.IEnumerable<VirtualPath> fileNames, String directoryPathInArchive)
        {
                             ...
                             String directoryPathInArchive)
        {
            ...
            {
                foreach (VirtualPath f in fileNames)
                {
                    ...
                    if (directoryPathInArchive != null)
                    {
                        ...
                        string s = directoryPathInArchive + f.Container.FullName; //FIXME LOGAN HACKED THIS LINE
                        this.AddFile(f, s);
                    }
                    else
                        this.AddFile(f, null);
        ...
        /// </param>
        ///
        public void UpdateFiles(System.Collections.Generic.IEnumerable<VirtualPath> fileNames, String directoryPathInArchive)
        {
            if (fileNames == null)
                throw new ArgumentNullException("fileNames");
        ...
        /// </returns>
        public ZipEntry UpdateFile(VirtualPath fileName)
        {
        ...
        ///   The <c>ZipEntry</c> corresponding to the File that was added or updated.
        /// </returns>
        public ZipEntry UpdateFile(VirtualPath fileName, String directoryPathInArchive)
        {
        ...
        /// </returns>
        public ZipEntry UpdateDirectory(VirtualPath directoryName)
        {
        ...
        ///   The <c>ZipEntry</c> corresponding to the Directory that was added or updated.
        /// </returns>
        public ZipEntry UpdateDirectory(VirtualPath directoryName, String directoryPathInArchive)
        {
        ...
        /// </param>
        public void UpdateItem(VirtualPath itemName)
        {
        ...
        ///   item at the root path within the archive.
        /// </param>
        public void UpdateItem(VirtualPath itemName, string directoryPathInArchive)
        {
            if (!_fileSystem.Exists(itemName))
            {
                throw new FileNotFoundException(String.Format("That file or directory ({0}) does not exist!", itemName));
            }

            if (_fileSystem.WhatIs(itemName) == ResourceType.Directory)
            {
        ...
        /// <returns>The <c>ZipEntry</c> added.</returns>
        ///
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Reliability", "CA2000:Dispose objects before losing scope", Justification = "Streams are long-lived and their disposal is managed by the ZipEntry")]
        ...
        /// </example>
        ///
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.UpdateEntry(string, System.IO.Stream)"/>
        ///
        /// <param name="entryName">
        ...
        {
            ZipEntry ze = ZipEntry.CreateForStream(_logger, _fileSystem, entryName, stream);
        ...
        ///
        /// using(Durandal.Common.Compression.Zip.ZipFile zip = new Durandal.Common.Compression.Zip.ZipFile())
        /// {
        ...
        {
            ZipEntry ze = ZipEntry.CreateForWriter(_logger, _fileSystem, entryName, writer);
            if (Verbose) StatusMessageTextWriter.WriteLine("adding {0}...", entryName);
            return _InternalAddEntry(ze);
        }
        ...
        {
            ZipEntry ze = ZipEntry.CreateForJitStreamProvider(_logger, _fileSystem, entryName, opener, closer);
            ze.SetEntryTimes(DateTime.Now,DateTime.Now,DateTime.Now);
            if (Verbose) StatusMessageTextWriter.WriteLine("adding {0}...", entryName);
            return _InternalAddEntry(ze);
        }
        ...
        /// </remarks>
        ///
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipFile.AddEntry(string, System.IO.Stream)"/>
        /// <seealso cref="Durandal.Common.Compression.Zip.ZipEntry.InputStream"/>
        ///
        /// <param name="entryName">
        ///   The name, including any path, to use within the archive for the entry.
        /// </param>
...
//         }
        ...
        /// <returns>The <c>ZipEntry</c> added.</returns>
        public ZipEntry AddDirectory(VirtualPath directoryName)
        {
        ...
        ///
        /// <returns>The <c>ZipEntry</c> added.</returns>
        public ZipEntry AddDirectory(VirtualPath directoryName, string directoryPathInArchive)
        {
        ...
        {
            // workitem 9073
            ZipEntry dir = ZipEntry.CreateFromNothing(_logger, _fileSystem, directoryNameInArchive);
        ...
        private ZipEntry AddOrUpdateDirectoryImpl(VirtualPath directoryName,
                                                  ...
                                                  int level)
        {
            ...
            if (level > 0)
            {
                int f = directoryName.FullName.Length;
                for (int i = level; i > 0; i--)
                    f = directoryName.FullName.LastIndexOf(VirtualPath.PATH_SEPARATOR_CHAR, f - 1, f - 1);

                dirForEntries = directoryName.FullName.Substring(f + 1);
            ...
            {
                baseDir = ZipEntry.CreateFromFile(_logger, _fileSystem, directoryName, dirForEntries);
            ...
            if (!_addOperationCanceled)
            {
                IEnumerable<VirtualPath> filenames = _fileSystem.ListFiles(directoryName);
                ...
                if (recurse)
                {
                    ...
                    if (!_addOperationCanceled)
                    {
                        ...
                        IEnumerable<VirtualPath> dirnames = _fileSystem.ListDirectories(directoryName);
