...
{
    /// <summary>
    /// Defines an audio capture device that can be handled by a specific <see cref="IAudioDriver"/>.
    /// Different implementations are provided by different drivers and cannot be interchanged.
    /// </summary>
    public interface IAudioCaptureDeviceId : IEquatable<IAudioCaptureDeviceId>
    {
        /// <summary>
