...
{
    public sealed class RiffWaveCodecFactory : IAudioCodecFactory
    {
            ...
            string nodeCustomName)
        {
            ...
            return new RiffWaveDecoder(graph, nodeCustomName);
        }
            ...
            string nodeCustomName)
        {
            ...
            return new RiffWaveEncoder(graph, desiredInputFormat, nodeCustomName, traceLogger);
        }
    }
}
