...
#pragma warning restore CA2213
        ...
        virtual public FlushType FlushMode
        {
            ...
            set
            {
                if (_disposed) throw new ObjectDisposedException(nameof(DeflateStream));
        ...
        public static String UncompressString(byte[] compressed)
        {
            ...
            using (System.IO.Stream decompressor = new DeflateStream(input, CompressionMode.Decompress))
            {
