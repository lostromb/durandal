...
{
    /// <summary>
    /// Represents a precomputed state engine for running 1-dimensional float64 complex to complex Fourier transforms.
    /// </summary>
    public interface IComplex1DFFTPlanFloat64 : I1DFFTPlan
    {
        ...
        void Forward(Span<Complex> c, double fct);
        ...
        /// <param name="c">The array of complex numbers to be transformed in-place.</param>
        /// <param name="fct">A scaling parameter to scale the results of the transform.</param>
        void Backward(Span<Complex> c, double fct);
    }
}
