...
{
    /// <summary>
    /// <para>AdministrativeArea</para>
    /// <para>A geographical region, typically under the jurisdiction of a particular government.</para>
    /// </summary>
    internal class AdministrativeArea : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/Place", "http://schema.org/Thing" };

        public AdministrativeArea(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/AdministrativeArea", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public AdministrativeArea(Entity castFrom) : base(castFrom, "http://schema.org/AdministrativeArea") { Initialize(); }
