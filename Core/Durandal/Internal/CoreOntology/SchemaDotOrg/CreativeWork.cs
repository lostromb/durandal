...
{
    /// <summary>
    /// <para>CreativeWork</para>
    /// <para>The most generic kind of creative work, including books, movies, photographs, software programs, etc.</para>
    /// </summary>
    internal class CreativeWork : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/Thing" };

        public CreativeWork(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/CreativeWork", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public CreativeWork(Entity castFrom) : base(castFrom, "http://schema.org/CreativeWork") { Initialize(); }
