    ...
    public class PlaybackDevice : IDisposable
    {
        ...
        public static PlaybackDevice GetByIndex(int Device)
        {
            ...
            if (!Bass.GetDeviceInfo(Device, out info))
                throw new ArgumentOutOfRangeException("Device", "Invalid PlaybackDevice Index");
        ...
        /// No Sound Device.
        /// </summary>
        public static PlaybackDevice NoSound
        {
            get
            {
                return GetByIndex(0);
        ...
        /// </summary>
        public static PlaybackDevice Default
        {
            get
            {
                return Devices.First(Dev => Dev.Info.IsDefault);
            }
        }
        ...
        /// </summary>
        public static BassInfo CurrentInfo
        {
            get
            {
                return Bass.Info;
        ...
        public DeviceInfo Info
        {
            get
            {
                return Bass.GetDeviceInfo(Index);
            }
        }
