...
{
    [TestClass]
    public class Test_SealedInternalizer_Char_PerfectHash
    {
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_Basic()
        {
            ...
            SealedInternalizer_Char_PerfectHash internalizer = new SealedInternalizer_Char_PerfectHash(dict);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_Random()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_NullInput()
        {
            try
            {
                SealedInternalizer_Char_PerfectHash internalizer = new SealedInternalizer_Char_PerfectHash(null);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_ContainsEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_ZeroZeroIsAllowed()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_ContainsMultipleEmptyValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            dict[new InternedKey<ReadOnlyMemory<char>>(1)] = new char[0];
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_DoesntContainEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_DoesntContainEmpty2()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_NoInputs()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            SealedInternalizer_Char_PerfectHash internalizer = new SealedInternalizer_Char_PerfectHash(dict);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_ThrowsExceptionOnDuplicateValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            dict[new InternedKey<ReadOnlyMemory<char>>(1)] = "One".AsMemory();
            dict[new InternedKey<ReadOnlyMemory<char>>(2)] = "One".AsMemory();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_ReliablyConstructsTree()
        {
            IRandom random = new FastRandom(5423);
            StringBuilder builder = new StringBuilder();
            HashSet<string> existingStrings = new HashSet<string>();
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_RedundantOrdinals()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_Char_PerfectHash_CaseSensitivity()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
