...
{
    [TestClass]
    public class Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked
    {
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_Basic()
        {
            ...
            SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked internalizer = new SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked(dict);
            Assert.AreEqual(InternalizerFeature.CaseInsensitive | InternalizerFeature.OnlyMatchesWithinSet, internalizer.Features);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_Random()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_NullInput()
        {
            try
            {
                SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked internalizer = new SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked(null);
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_ContainsEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_ZeroZeroIsAllowed()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_ContainsMultipleEmptyValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            dict[new InternedKey<ReadOnlyMemory<char>>(1)] = new char[0];
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_DoesntContainEmpty()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_ThrowsExceptionOnDuplicateValues()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
            dict[new InternedKey<ReadOnlyMemory<char>>(1)] = "One".AsMemory();
            dict[new InternedKey<ReadOnlyMemory<char>>(2)] = "One".AsMemory();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_ReliablyConstructsTree()
        {
            IRandom random = new FastRandom(76664);
            StringBuilder builder = new StringBuilder();
            HashSet<string> existingStrings = new HashSet<string>();
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_RedundantOrdinals()
        {
        ...
        [TestMethod]
        public void Test_SealedInternalizer_CharIgnoreCase_PerfectHash_Unchecked_CaseSensitivity()
        {
            Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>> dict = new Dictionary<InternedKey<ReadOnlyMemory<char>>, ReadOnlyMemory<char>>();
