namespace Durandal.Tests.Common.Dialog.Runtime
{
    ...
    public class ProcessContainerTests
    {
        ...
        private static ProcessIsolatedPluginProvider _mockPluginProvider;
        ...
        public static void InitializeClass(TestContext context)
        {
            ...
            _remotingConfig.IpcProtocol = "json";
        ...
        /// <summary>
        /// Tests that we can load a package into a process isolated container and have it execute successfully
        /// </summary>
        [Ignore]
        [TestMethod]
        public async Task TestProcessContainerPluginBasicSuccess()
        {
        ...
        [Ignore]
        [TestMethod]
        public async Task TestProcessContainerPluginOAuthService()
        {
            if (!_mockPluginProvider.HasDevRuntimeAvailable("netcore"))
            {
                Assert.Inconclusive("Dev runtime not found for process-level container. Will not run test in case the runtime version is out of date.");
        ...
        [Ignore]
        [TestMethod]
        public async Task TestProcessContainerPluginViewData()
        {
            if (!_mockPluginProvider.HasDevRuntimeAvailable("netcore"))
            {
                Assert.Inconclusive("Dev runtime not found for process-level container. Will not run test in case the runtime version is out of date.");
        ...
        /// <summary>
        /// Tests that keepalive is properly measured in process containers
        /// </summary>
        [Ignore]
        [TestMethod]
        public async Task TestProcessContainerKeepAlive()
        {
            if (!_mockPluginProvider.HasDevRuntimeAvailable("netcore"))
            {
                Assert.Inconclusive("Dev runtime not found for process-level container. Will not run test in case the runtime version is out of date.");
        ...
        /// <summary>
        /// Tests that we can crash a process container, continue sending traffic to it, and watch it autorecover
        /// as the watchdogs trigger the container to recycle internally.
        /// </summary>
        [Ignore]
        [TestMethod]
        public async Task TestProcessContainerRecoversAfterCrash()
        {
            if (!_mockPluginProvider.HasDevRuntimeAvailable("netcore"))
            {
                Assert.Inconclusive("Dev runtime not found for process-level container. Will not run test in case the runtime version is out of date.");
