...
{
    /// <summary>
    /// <para>MusicRecording</para>
    /// <para>A music recording (track), usually a single song.</para>
    /// </summary>
    internal class MusicRecording : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/CreativeWork", "http://schema.org/Thing" };

        public MusicRecording(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/MusicRecording", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public MusicRecording(Entity castFrom) : base(castFrom, "http://schema.org/MusicRecording") { Initialize(); }
        ...
        {
            RecordingOf = new IdentifierValue<Entity>(_context, EntityId, "recordingOf");
            IsrcCode = new TextValue(_context, EntityId, "isrcCode");
            InAlbum = new IdentifierValue<Entity>(_context, EntityId, "inAlbum");
            InPlaylist = new IdentifierValue<Entity>(_context, EntityId, "inPlaylist");
            ByArtist = new IdentifierValue<Entity>(_context, EntityId, "byArtist");
        ...
        /// <summary>
        /// <para>(From http://schema.org/MusicRecording)</para>
        /// <para>The composition this track is a recording of.</para>
        /// </summary>
        public IdentifierValue<Entity> RecordingOf { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/MusicRecording)</para>
        /// <para>The International Standard Recording Code for the recording.</para>
        /// </summary>
        public TextValue IsrcCode { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/MusicRecording)</para>
        /// <para>The album to which this recording belongs.</para>
        /// </summary>
        public IdentifierValue<Entity> InAlbum { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/MusicRecording)</para>
        /// <para>The playlist to which this recording belongs.</para>
        /// </summary>
        public IdentifierValue<Entity> InPlaylist { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/MusicRecording)</para>
        /// <para>The artist that performed this album or recording.</para>
        /// </summary>
        public IdentifierValue<Entity> ByArtist { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/MusicRecording)</para>
