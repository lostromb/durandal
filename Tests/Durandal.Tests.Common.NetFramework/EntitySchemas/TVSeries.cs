...
namespace Durandal.Tests.EntitySchemas
{
    ...
    /// </summary>
    internal class TVSeries : Entity
    {
        private static HashSet<string> _inheritance = new HashSet<string>() { "http://schema.org/CreativeWork", "http://schema.org/CreativeWorkSeries", "http://schema.org/Thing" };

        public TVSeries(KnowledgeContext context, string entityId = null) : base(context, "http://schema.org/TVSeries", entityId) { Initialize(); }

        /// <summary>
        /// Casting constructor
        /// </summary>
        /// <param name="castFrom">The entity that this one is being cast from</param>
        public TVSeries(Entity castFrom) : base(castFrom, "http://schema.org/TVSeries") { Initialize(); }
        ...
        {
            Seasons = new IdentifierValue<Entity>(_context, EntityId, "seasons");
            Actor = new IdentifierValue<Person>(_context, EntityId, "actor");
            NumberOfEpisodes = new IdentifierValue<Entity>(_context, EntityId, "numberOfEpisodes");
            Trailer = new IdentifierValue<Entity>(_context, EntityId, "trailer");
            Season = new IdentifierValue<Entity>(_context, EntityId, "season");
            Episodes = new IdentifierValue<Entity>(_context, EntityId, "episodes");
            ...
            ContainsSeason = new IdentifierValue<Entity>(_context, EntityId, "containsSeason");
            Directors = new IdentifierValue<Person>(_context, EntityId, "directors");
            NumberOfSeasons = new IdentifierValue<Entity>(_context, EntityId, "numberOfSeasons");
            ...
            Episode = new IdentifierValue<Entity>(_context, EntityId, "episode");
        ...
        /// <summary>
        /// <para>(From http://schema.org/TVSeries)</para>
        /// <para>A season in a media series.</para>
        /// </summary>
        public IdentifierValue<Entity> Seasons { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/TVSeries)</para>
        ...
        /// </summary>
        public IdentifierValue<Entity> NumberOfEpisodes { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/TVSeries)</para>
        ...
        /// <para>A season in a media series.</para>
        /// </summary>
        public IdentifierValue<Entity> Season { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/TVSeries)</para>
        /// <para>An episode of a TV/radio series or season.</para>
        /// </summary>
        public IdentifierValue<Entity> Episodes { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/TVSeries)</para>
        ...
        /// </summary>
        public IdentifierValue<Entity> ContainsSeason { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/TVSeries)</para>
        ...
        /// </summary>
        public IdentifierValue<Entity> NumberOfSeasons { get; private set; }
        /// <summary>
        /// <para>(From http://schema.org/TVSeries)</para>
        ...
        /// </summary>
        public IdentifierValue<Entity> Episode { get; private set; }
        /// <summary>
