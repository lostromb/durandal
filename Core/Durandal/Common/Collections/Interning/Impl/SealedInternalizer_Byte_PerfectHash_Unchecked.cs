...
namespace Durandal.Common.Collections.Interning.Impl
{
    ...
    /// </summary>
    internal class SealedInternalizer_Byte_PerfectHash_Unchecked : ISealedPrimitiveInternalizer<byte>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="SealedInternalizer_Byte_PerfectHash_Unchecked"/> from a collection of already established
        ...
        public SealedInternalizer_Byte_PerfectHash_Unchecked(IReadOnlyCollection<KeyValuePair<InternedKey<ReadOnlyMemory<byte>>, ReadOnlyMemory<byte>>> entries)
        {
            if (entries == null)
            {
