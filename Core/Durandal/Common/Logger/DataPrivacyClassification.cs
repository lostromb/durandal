...
namespace Durandal.Common.Logger
{
    ...
    public enum DataPrivacyClassification : ushort
    {
        ...
        /// <summary>
        /// System-generated data that does not belong to any other class, or in other words, is not linkable to any particular user or tenant.
        /// Example: runtime log messages, traces, error messages, service status
        /// </summary>
        SystemMetadata = 0x1,

        /// <summary>
        /// Data that directly identifies or could be used to identify a user.
        ...
        /// <summary>
        /// Data that is generated and considered "private" by a user (i.e. not publically available). Also called Customer Content.
        /// Examples: user generated storage data (emails / images / files), customer owned secrets, machine built models over customer data,
        ...
        /// <summary>
        /// Data that is available publically and does not explicitly identify a single customer.
