...
namespace Durandal.Common.Remoting
{
    ...
    public class DurandalPluginLoadContext : AssemblyLoadContext
    {
        ...
        public DurandalPluginLoadContext(ILogger logger, DirectoryInfo runtimeDirectory, DirectoryInfo containerDirectory)
            : base (name: containerDirectory?.Name, isCollectible: true)
        {
            _logger = logger;
            _containerDirectory = containerDirectory.AssertNonNull(nameof(containerDirectory));
            _runtimeDirectory = runtimeDirectory.AssertNonNull(nameof(runtimeDirectory));
