...
namespace Durandal.Common.Speech.Triggers.Sphinx.Internal.Structs
{
    internal class feat_t
    {
        ...
        public cmn_t cmn_struct;  /*< Structure that stores the temporary variables for cepstral 
                           means normalization*/
        public agc_t agc_struct;  /*< Structure that stores the temporary variables for acoustic
                           gain control*/
         ...
         **/
        public delegate void compute_feat(feat_t fcb, Pointer<Pointer<float>> input, Pointer<Pointer<float>> feats);
    }
}
